<template>
  <div class="privacy" id="ftrs">
    ...
    <p>PixoPixa ("us", "we", or "our") operates the www.pixopixa.com website (the "Service").</p>

    <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. This Privacy Policy  for PixoPixa is powered by <a href="https://freeprivacypolicy.com/">FreePrivacyPolicy.com</a>.</p>
    ...
    <p>We use your data to provide and improve the Service. By using the Service, you agree to
      ...
      meanings as in our Terms and Conditions, accessible from www.pixopixa.com</p>
    ...
    <p>PixoPixa uses the collected data for various purposes:</p>
    <ul>
    ...
    <p>If you are located outside Cambodia and choose to provide information to us,
      please note that we transfer the data, including Personal Data, to Cambodia
    ...
    <p>PixoPixa will take all steps reasonably necessary to ensure that your data is treated
      securely
    ...
    <p>PixoPixa may disclose your Personal Data in the good faith belief
      that such action is necessary to:</p>
    <ul>
      <li>To comply with a legal obligation</li>
      <li>To protect and defend the rights or property of PixoPixa</li>
    ...
    <p>We may employ third party companies and individuals to facilitate our
      ...
      perform Service-related services or to assist us in analyzing how our Service is used.</p>
    ...
    <ul>
      <li>By email: admin@pixopixa.com</li>
